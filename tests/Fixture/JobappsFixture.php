 ...
 *
 */
class JobappsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'department_id' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'submissiondate' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'department_id' => 1,
            'submissiondate' => '2017-12-07 12:41:04'
        ],
    ];
}
