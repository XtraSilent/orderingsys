...
class SurveysFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'topic' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'surveydate' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'surveydate' => '2017-12-07 12:41:04'
        ],
    ];
}
